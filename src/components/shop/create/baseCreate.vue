  ...
  <el-form ref="form" label-width="80px">
    <el-form-item label="商品名称">
      <el-input
        ...
        placeholder="请输入商品的名称，不能超过60个字符"
      ></el-input>
    </el-form-item>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      unit: (state) => state.goods_create.unit, // 单位
      stock: (state) => state.goods_create.stock, // 总库存
      min_stock: (state) => state.goods_create.min_stock, // 库存预警
      display_stock: (state) => state.goods_create.display_stock, // 库存显示 0隐藏 1显示
      status: (state) => state.goods_create.status, // 是否上架 0仓库 1上架
