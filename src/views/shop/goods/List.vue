<template>
  <div class="bg-white pl-2" style="margin: -20px; margin-top: -10px; margin-bottom: 0!important; ">
          ...
          >
            <template #left>
              ...
              <router-link :to="{name: 'shop_goods_create'}">
                <el-button type="success" size="mini" @click="successClick">发布商品</el-button>
              </router-link>
        ...
        <div class="content">
          <el-table  
            ...
            <el-table-column label="商品状态" align="center" >
              <template slot-scope="scope">
                <el-button type="success" size="mini" :plain="true" @click="scope.row.ischeck = 1" >审核通过</el-button>
                <el-button class="ml-0 mt-2" type="danger" size="mini" :plain="true" @click="scope.row.ischeck = 2" >审核拒绝</el-button>   
            ...
            <el-table-column label="操作" align="center" width="150px">
              <template slot-scope="scope">
                <el-button-group>
                  <el-button type="primary" size="mini" :plain="true">修改</el-button>
                  <el-button type="danger" size="mini" :plain="true" @click="deleteItem(scope.$index)">删除</el-button>
                </el-button-group>
              </template>
            </el-table-column>
          </el-table>
